...
\frame{
  ...
  \begin{itemize}
    ...
    \item Associados
      ...
      \end{itemize}
    \item Estatutos: \url{https://wiki.openstack.org/wiki/Governance/Foundation/Bylaws}
    \item \url{http://lists.openstack.org/pipermail/foundation/}
  \end{itemize}
  ...
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
      \begin{itemize}
        \item Estratégica
        \item Financeira
        \item \url{http://lists.openstack.org/pipermail/foundation-board/}
      \end{itemize}
    \end{column}
  \end{columns}
}
...
\frame{
  ...
  \begin{itemize}
    \item Defcore Committee
      \begin{itemize}
        \item \url{http://lists.openstack.org/pipermail/defcore-committee/}
        \item \url{https://wiki.openstack.org/wiki/Governance/DefCoreCommittee}\footnote{Visitado em 09/09/2016}
